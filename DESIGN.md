...
```
13,312  total
  -100  Wavedash SDK reserve (measured)
-12,450  game
─────────
   762  contingency
```

**Hard ceiling: 12,450 bytes for the game.** `npm run size` must pack and print actual zip bytes against both 13,312 and 11,750 after every build.
